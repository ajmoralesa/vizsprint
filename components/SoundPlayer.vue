<template>
  <div class="absolute right-4 top-4">
    <div id="dark-mode-toggle" class="cursor-pointer">
      <svg
        ...
        class="h-6 w-6 stroke-white hidden dark:block"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        stroke-width="2"
      ...
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6 stroke-[#0A1122] block dark:hidden"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        stroke-width="2"
  ...
  <div
    class="bg-[#F8FAFC] dark:bg-[#0A1122] w-screen h-screen flex flex-col items-center justify-center"
  >
    <div
    ...
    >
      <div class="px-10 pt-10 pb-4 flex items-center z-50"></div>
...
.shadow-player-light {
  --tw-shadow: 0px 15px 25px rgba(15, 23, 42, 0.1),
    0px 5px 10px rgba(15, 23, 42, 0.04);
  --tw-shadow-colored: 0px 15px 25px var(--tw-shadow-color),
    0px 5px 10px var(--tw-shadow-color);
